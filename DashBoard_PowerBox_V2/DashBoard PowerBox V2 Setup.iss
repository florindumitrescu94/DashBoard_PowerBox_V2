...
; Generated by flo on 3/12/2024 (UTC)
;
[Setup]
AppID={{0b094eef-7404-48a9-8e37-0bed42348751}
AppName=ASCOM DashBoard PowerBox V2 Switch Driver
AppVerName=ASCOM DashBoard PowerBox V2 Switch Driver 2.0.4
AppVersion=2.0.4
...
OutputDir="."
OutputBaseFilename="DashBoard PowerBox V2 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\DashBoard PowerBox V2"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\DashBoard PowerBox V2"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM DashBoard PowerBox V2 Switch Driver"
...
begin
   ...
   P.DeviceType := 'Switch';
   P.Register('DashBoard PowerBox V2.Switch', 'DashBoard PowerBox V2');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'Switch';
     P.Unregister('DashBoard PowerBox V2.Switch');
  end;
end;
