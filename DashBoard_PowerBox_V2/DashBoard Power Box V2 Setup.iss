...
; Generated by flo on 1/30/2024 (UTC)
;
[Setup]
AppID={{f0f063e0-3dec-4df5-bc37-29ba10720c30}
AppName=ASCOM DashBoard Power Box V2 Switch Driver
AppVerName=ASCOM DashBoard Power Box V2 Switch Driver 2.0.1
AppVersion=2.0.1
...
OutputDir="."
OutputBaseFilename="DashBoard Power Box V2 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\DashBoard Power Box V2"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\DashBoard Power Box V2"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM DashBoard Power Box V2 Switch Driver"
...
begin
   ...
   P.DeviceType := 'Switch';
   P.Register('DashBoard Power Box V2.Switch', 'DashBoard Power Box V2');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'Switch';
     P.Unregister('DashBoard Power Box V2.Switch');
  end;
end;
